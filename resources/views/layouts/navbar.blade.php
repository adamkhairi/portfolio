...
<div id="menu"
    ...
    <div class="flex flex-col items-center font-extrabold text-4xl justify-center w-full">
        <a href="{{url('/')}}" class="py-3 rounded hover:bg-black hover:text-gray-400 w-2/6 text-center">Home</a>
        <a href="{{url('/#about')}}" class="py-3 rounded hover:bg-black hover:text-gray-400 w-2/6 text-center">About</a>
